...
- [ ] Add this readme as a page on the demo site

## Open Source Attributions
The Starter Kit is based on Laravel Breeze

Featured images on blog posts used by the seeder come from  [picsum.photos](https://picsum.photos/)
The Frontend components are from [Flowbite](https://github.com/themesberg/flowbite) (MIT)
